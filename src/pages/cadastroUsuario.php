            ...
            <form action="#">
                ...
                <div class="input-group">
                    ...
                    <div class="input-box">
                        ...
                        <input id="confirmPassword" type="password" name="confirmPassword" placeholder="Confirme Senha" required>
                    </div>

                </div>

                <div class="entrar-button">
                    <button><a href="cadastroProdutos.php" target="_blank">Criar Conta</a> </button>
                </div>
            </form>
        </div>
    </div>
